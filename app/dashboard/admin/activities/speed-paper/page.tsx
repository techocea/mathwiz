            ...
            <main className="min-h-screen flex-1 container lg:max-w-6xl mx-auto p-6">
                <div>
                    <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-8 gap-4">
                        <div>
                            <h1 className="text-3xl font-bold mb-2">Speed Paper Management</h1>
                            <p className="text-muted-foreground">
                                Create and manage speed papers
                            </p>
                        </div>

                        <Button
                            size="lg"
                            onClick={() => router.push("/dashboard/admin/activities/speed-paper/create")}
